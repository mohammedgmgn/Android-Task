...
abstract class ActivityBuilder {
    @PerActivity
    @ContributesAndroidInjector(modules = [FragmentsModule::class, DeliveriesActivityModule::class])
...
abstract class FragmentsModule {
    @ContributesAndroidInjector(modules = [DeliveriesListFragmentModule::class])
